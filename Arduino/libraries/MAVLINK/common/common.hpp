...
{
    NAV_WAYPOINT=16, /* Navigate to waypoint. |1: Hold time. (ignored by fixed wing, time to stay at waypoint for rotary wing)| 2: , the waypoint counts as reached)| 3: 0 radius to pass by WP. Positive value for clockwise orbit, negative value for counter-clockwise orbit. Allows trajectory control.| 4: Desired yaw angle at waypoint (rotary wing). NaN for unchanged.| 5: Latitude| 6: Longitude| 7: Altitude|  */
    NAV_LOITER_UNLIM=17, /* Loiter around this waypoint an unlimited amount of time |1: Empty| 2: Empty| 3: Radius around waypoint. If positive loiter clockwise, else counter-clockwise| 4: Desired yaw angle.| 5: Latitude| 6: Longitude| 7: Altitude|  */
    NAV_LOITER_TURNS=18, /* Loiter around this waypoint for X turns |1: Number of turns.| 2: Empty| 3: Radius around waypoint. If positive loiter clockwise, else counter-clockwise| 4: Forward moving aircraft this sets exit xtrack location: 0 for center of loiter wp, 1 for exit location. Else, this is desired yaw angle| 5: Latitude| 6: Longitude| 7: Altitude|  */
    NAV_LOITER_TIME=19, /* Loiter around this waypoint for X seconds |1: Loiter time.| 2: Empty| 3: Radius around waypoint. If positive loiter clockwise, else counter-clockwise.| 4: Forward moving aircraft this sets exit xtrack location: 0 for center of loiter wp, 1 for exit location. Else, this is desired yaw angle| 5: Latitude| 6: Longitude| 7: Altitude|  */
    NAV_RETURN_TO_LAUNCH=20, /* Return to launch location |1: Empty| 2: Empty| 3: Empty| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
    NAV_LAND=21, /* Land at location. |1: Minimum target altitude if landing is aborted (0 = undefined/use system default).| 2: Precision land mode.| 3: Empty.| 4: Desired yaw angle. NaN for unchanged.| 5: Latitude.| 6: Longitude.| 7: Landing altitude (ground level in current frame).|  */
    NAV_TAKEOFF=22, /* Takeoff from ground / hand |1: sor| 2: Empty| 3: Empty| 4: Yaw angle (if magnetometer present), ignored without magnetometer. NaN for unchanged.| 5: Latitude| 6: Longitude| 7: Altitude|  */
    ...
    NAV_PATHPLANNING=81, /* Control autonomous path planning on the MAV. |1: 0: Disable local obstacle avoidance / local path planning (without resetting map), 1: Enable local path planning, 2: Enable and reset local path planning| 2: e and reset planned route, but not occupancy grid| 3: Empty| 4: Yaw angle at goal| 5: Latitude/X of goal| 6: Longitude/Y of goal| 7: Altitude/Z of goal|  */
    NAV_SPLINE_WAYPOINT=82, /* Navigate to waypoint using a spline path. |1: Hold time. (ignored by fixed wing, time to stay at waypoint for rotary wing)| 2: Empty| 3: Empty| 4: Empty| 5: Latitude/X of goal| 6: Longitude/Y of goal| 7: Altitude/Z of goal|  */
    NAV_VTOL_TAKEOFF=84, /* Takeoff from ground using VTOL mode, and transition to forward flight with specified heading. |1: Empty| 2: Front transition heading.| 3: Empty| 4: Yaw angle in degrees. NaN for unchanged.| 5: Latitude| 6: Longitude| 7: Altitude|  */
    NAV_VTOL_LAND=85, /* Land using VTOL mode |1: Empty| 2: Empty| 3: Approach altitude (with the same reference as the Altitude field). NaN if unspecified.| 4: Yaw angle. NaN for unchanged.| 5: Latitude| 6: Longitude| 7: Altitude (ground level)|  */
    ...
    NAV_DELAY=93, /* Delay the next navigation command a number of seconds or until a specified time |1: Delay (-1 to enable time-of-day fields)| 2: hour (24h format, UTC, -1 to ignore)| 3: minute (24h format, UTC, -1 to ignore)| 4: second (24h format, UTC)| 5: Empty| 6: Empty| 7: Empty|  */
    ...
    CONDITION_CHANGE_ALT=113, /* Ascend/descend at rate.  Delay mission state machine until desired altitude reached. |1: Descent / Ascend rate.| 2: Empty| 3: Empty| 4: Empty| 5: Empty| 6: Empty| 7: Finish Altitude|  */
    CONDITION_DISTANCE=114, /* Delay mission state machine until within desired distance of next NAV point. |1: Distance.| 2: Empty| 3: Empty| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
    CONDITION_YAW=115, /* Reach a certain target angle. |1: target angle, 0 is north| 2: angular speed| 3: direction: -1: counter clockwise, 1: clockwise| 4: 0: absolute angle, 1: relative offset| 5: Empty| 6: Empty| 7: Empty|  */
    ...
    DO_SET_MODE=176, /* Set system mode. |1: Mode| 2: Custom mode - this is system specific, please refer to the individual autopilot specifications for details.| 3: Custom sub mode - this is system specific, please refer to the individual autopilot specifications for details.| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
    ...
    DO_CHANGE_SPEED=178, /* Change speed and/or throttle set points. |1: Speed type (0=Airspeed, 1=Ground Speed, 2=Climb Speed, 3=Descent Speed)| 2: Speed (-1 indicates no change)| 3: Throttle (-1 indicates no change)| 4: 0: absolute, 1: relative| 5: Empty| 6: Empty| 7: Empty|  */
    ...
    DO_SET_RELAY=181, /* Set a relay to a condition. |1: Relay instance number.| 2: Setting. (1=on, 0=off, others possible depending on system hardware)| 3: Empty| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
    DO_REPEAT_RELAY=182, /* Cycle a relay on and off for a desired number of cycles with a desired period. |1: Relay instance number.| 2: Cycle count.| 3: Cycle time.| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
    DO_SET_SERVO=183, /* Set a servo to a desired PWM value. |1: Servo instance number.| 2: Pulse Width Modulation.| 3: Empty| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
    DO_REPEAT_SERVO=184, /* Cycle a between its nominal setting and a desired PWM for a desired number of cycles with a desired period. |1: Servo instance number.| 2: Pulse Width Modulation.| 3: Cycle count.| 4: Cycle time.| 5: Empty| 6: Empty| 7: Empty|  */
    DO_FLIGHTTERMINATION=185, /* Terminate flight immediately |1: 0.5| 2: Empty| 3: Empty| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
    DO_CHANGE_ALTITUDE=186, /* Change altitude set point. |1: Altitude.| 2: Frame of new altitude.| 3: Empty| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
    ...
    DO_RALLY_LAND=190, /* Mission command to perform a landing from a rally point. |1: Break altitude| 2: Landing speed| 3: Empty| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
    DO_GO_AROUND=191, /* Mission command to safely abort an autonomous landing. |1: Altitude| 2: Empty| 3: Empty| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
    DO_REPOSITION=192, /* Reposition the vehicle to a specific WGS84 global position. |1: Ground speed, less than 0 (-1) for default| 2: Bitmask of option flags.| 3: Reserved| 4: Yaw heading, NaN for unchanged. For planes indicates loiter direction (0: clockwise, 1: counter clockwise)| 5: Latitude (deg * 1E7)| 6: Longitude (deg * 1E7)| 7: Altitude (meters)|  */
    DO_PAUSE_CONTINUE=193, /* If in a GPS controlled position mode, hold the current position or continue. |1: sion or reposition command, hold current position. 1: Continue mission. A VTOL capable vehicle should enter hover mode (multicopter and VTOL planes). A plane should loiter with the default loiter radius.| 2: Reserved| 3: Reserved| 4: Reserved| 5: Reserved| 6: Reserved| 7: Reserved|  */
    ...
    DO_CONTROL_VIDEO=200, /* Control onboard camera system. |1: Camera ID (-1 for all)| 2: Transmission: 0: disabled, 1: enabled compressed, 2: enabled raw| 3: 0: single images every n seconds| 4: Recording: 0: disabled, 1: enabled compressed, 2: enabled raw| 5: Empty| 6: Empty| 7: Empty|  */
    ...
    DO_MOUNT_CONFIGURE=204, /* Mission command to configure a camera or antenna mount |1: Mount operation mode| 2: stabilize roll? (1 = yes, 0 = no)| 3: stabilize pitch? (1 = yes, 0 = no)| 4: stabilize yaw? (1 = yes, 0 = no)| 5: ular rate, 2 = angle absolute frame)| 6: pitch input (0 = angle body frame, 1 = angular rate, 2 = angle absolute frame)| 7: yaw input (0 = angle body frame, 1 = angular rate, 2 = angle absolute frame)|  */
    ...
    DO_SET_CAM_TRIGG_DIST=206, /* Mission command to set camera trigger distance for this flight. The camera is triggered each time this distance is exceeded. This command can also be used to set the shutter integration time for the camera. |1: Camera trigger distance. 0 to stop triggering.| 2: Camera shutter integration time. -1 or 0 to ignore| 3: Trigger camera once immediately. (0 = no trigger, 1 = trigger)| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
    ...
    DO_MOTOR_TEST=209, /* Mission command to perform motor test. |1: Motor instance number. (from 1 to max number of motors on the vehicle)| 2: Throttle type.| 3: Throttle.| 4: Timeout.| 5: Motor count. (number of motors to test to test in sequence, waiting for the timeout above between them; 0=1 motor, 1=1 motor, 2=2 motors...)| 6: Motor test order.| 7: Empty|  */
    DO_INVERTED_FLIGHT=210, /* Change to/from inverted flight. |1: Inverted flight. (0=normal, 1=inverted)| 2: Empty| 3: Empty| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
    NAV_SET_YAW_SPEED=213, /* Sets a desired vehicle turn angle and speed change. |1: Yaw angle to adjust steering by.| 2: speed - normalized to 0 .. 1| 3: Empty| 4: Empty| 5: Empty| 6: Empty| 7: Empty|  */
    ...
    PREFLIGHT_REBOOT_SHUTDOWN=246, /* Request the reboot or shutdown of system components. |1: 0: Do nothing for autopilot, 1: Reboot autopilot, 2: Shutdown autopilot, 3: Reboot autopilot and keep it in the bootloader until upgraded.| 2: 0: Do nothing for onboard computer, 1: Reboot onboard computer, 2: Shutdown onboard computer, 3: Reboot onboard computer and keep it in the bootloader until upgraded.| 3: era and keep it in the bootloader until upgraded| 4: WIP: 0: Do nothing for mount (e.g. gimbal), 1: Reboot mount, 2: Shutdown mount, 3: Reboot mount and keep it in the bootloader until upgraded| 5: Reserved, send 0| 6: Reserved, send 0| 7: WIP: ID (e.g. camera ID -1 for all IDs)|  */
    ...
    COMPONENT_ARM_DISARM=400, /* Arms / Disarms a component |1: 0: disarm, 1: arm| 2: Reserved (default:0)| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
    ...
    START_RX_PAIR=500, /* Starts receiver pairing. |1: 0:Spektrum.| 2: RC type.| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
    ...
    VIDEO_START_CAPTURE=2500, /* Starts video capture (recording). Use NaN for reserved values. |1: Video Stream ID (0 for all streams)| 2: Frequency CAMERA_CAPTURE_STATUS messages should be sent while recording (0 for no messages, otherwise frequency)| 3: Reserved (all remaining params)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
    ...
    VIDEO_STOP_STREAMING=2503, /* Stop the given video stream |1: etc.)| 2: Reserved| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
    ...
    PANORAMA_CREATE=2800, /* Create a panorama at the current position |1: Viewing angle horizontal of the panorama (+- 0.5 the total angle)| 2: Viewing angle vertical of panorama.| 3: Speed of the horizontal rotation.| 4: Speed of the vertical rotation.| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
    DO_VTOL_TRANSITION=3000, /* Request VTOL transition |1: The target VTOL state. Only MAV_VTOL_STATE_MC and MAV_VTOL_STATE_FW can be used.| 2: Reserved (default:0)| 3: Reserved (default:0)| 4: Reserved (default:0)| 5: Reserved (default:0)| 6: Reserved (default:0)| 7: Reserved (default:0)|  */
    ...
    SPATIAL_USER_1=31005, /* User defined spatial item. Ground Station will not show the Vehicle as flying through this item. Example: ROI item. |1: User defined| 2: User defined| 3: User defined| 4: User defined| 5: Latitude unscaled| 6: gitude unscaled| 7: Altitude (MSL), in meters|  */
    ...
    SPATIAL_USER_4=31008, /* User defined spatial item. Ground Station will not show the Vehicle as flying through this item. Example: ROI item. |1: User defined| 2: User defined| 3: User defined| 4: User defined| 5: Latitude unscaled| 6: Longitude unscaled| 7: Altitude (MSL), in meters|  */
